...
export class TaskService {
  ...
  async createTemplate(
    ...
    const template: TaskTemplate = {
      ...
      ownerScope,
      requiresAcademicReview: ownerScope.kind === "ORGANIZATION" || input.requiresAcademicReview,
  ...
  private makeTask(
    ...
    return {
      ...
      requiresAcademicReview: source === "LEARNING_GROUP" || input.requiresAcademicReview,
      schedule: structuredClone(input.schedule),
      source,
